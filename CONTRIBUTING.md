...
| --------- | ---------------- | ----- |
| AIBase | [mcp.aibase.com/zh/server/1639703110358409836](https://mcp.aibase.com/zh/server/1639703110358409836) — update via [mcp.aibase.cn/submit](https://mcp.aibase.cn/submit) | Existing card; Chinese copy has gone stale (still said “50+ tools” in 2026). Re-submit with 122 tools, recipes, UI, Windows/macOS, and `npx -y @alisaitteke/photoshop-mcp`. |
...
> 跨平台（Windows / macOS）Photoshop MCP 服务器：122 个工具（含配方工作流与生成式 AI）、独立 Web UI。通过 Cursor / Claude 用自然语言控制 Photoshop。非 Adobe 官方。https://photoshop-mcp.com/
